  ...
  return (
    <div className='border p-6 shadow rounded'>
      <div className='flex justify-between items-center'>
        <img src={job.companyId.image} alt="" className='h-20 w-20'/>
      ...
      <p dangerouslySetInnerHTML={{__html: job.description.slice(0,150)}} className='text-gray-500 text-sm mt-4 '>
      ...
      <div className='flex items-center gap-4 text-sm mt-4'>
        <button onClick
        ={()=>{
          navigate(`/apply-job/${job._id}`);scrollTo(0,0);
        }}
