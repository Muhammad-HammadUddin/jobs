  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-linear-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl '>
            ...
            <p className='mb-8 max-w-xl mx-auto text-sm font-light px-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto, fugit reprehenderit. Explicabo, modi tempore? Expedita, veritatis error. Suscipit, magni cum?</p>
            <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                ...
                <button className='bg-blue-600 px-5 py-2 rounded text-white m-1' onClick={onSearch}>
                    Search
                </button>
            </div>
        </div>
